...
namespace ChecksumsApp{
    ...
    inline constexpr char const* URL_API_SEND_CONTACT_US = "http://127.0.0.1:8000/api/contactus_desktop";
    #else
    ...
    inline constexpr char const* URL_API_SEND_CONTACT_US = "https://checksums.app/api/contactus_desktop";
    #endif
