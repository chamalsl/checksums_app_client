...
_OBJ := contactus_window.o token_window.o main_window.o resources.o api.o utils.o pkce.o config.o third_party/json_parser/json_parser.o
ifeq ($(OS),Windows_NT)
	_OBJ += utils_win.o
else
	_OBJ += utils_linux.o
...
clean:
	...
	rm -f ${BUILD_DIR}checksums
	rm -f ${BUILD_DIR}run_tests
